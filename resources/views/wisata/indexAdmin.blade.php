...
<body>
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll active" href="#">Wisata Candi Borobudur</a>
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll" href="#">Wisata</a>
          </li>
          <li class="nav-item">
  ...
  <div class="intro intro-single route bg-image" style="background-image: url(/img/candiborobudur.jpg)">
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          <h2 class="intro-title mb-4">Wisata</h2>
        </div>
      </div>
    </div>
  </div>
      ...
      @foreach($data_wisata as $wisata)
        <div class="col-md-4">
          <div class="card card-blog">
            <div class="card-img">
              <a href="/pageAdminw/{{$wisata->id}}"><img src="{{$wisata->getGambar()}}" alt="" class="img-fluid"></a>
            </div>
            <div class="card-body">
              <h2 class="card-title"><a href="/pageAdmin/{{$wisata->id}}">{{$wisata->nama_wisata}}</a></h2>
              <p class="card-description">
                {{$wisata->deskripsi}}
              </p>
              <h6 class="card-description"><a href="blog-single.html">{{$wisata->lokasi}}</a></h6>
            </div>
            <div class="card-footer">
              <div class="post-author">
                <a href="#">
                  <span class="card-title">{{$wisata->waktu}}</span>
                </a>
              </div>
              <div class="post-date">
                <span class="card-title">{{$wisata->harga}}</span> 
              </div>
              <div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="form-group">
                ...
                <input name="nama_wisata" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
              </div>
              <div class="form-group">
