      ...
      @foreach($data_wisata as $wisata)
        <div class="col-md-4">
          <div class="card card-blog">
            <div class="card-img">
              <a href="/wisata/{{$wisata->id}}"><img src="{{$wisata->getGambar()}}" alt="" class="img-fluid"></a>
            </div>
            <div class="card-body">
              <h2 class="card-title"><a href="#">{{$wisata->nama_wisata}}</a></h2>
              <p class="card-description">
                {{$wisata->deskripsi}}
              </p>
              <h6 class="card-description"><a href="#">{{$wisata->lokasi}}</a></h6>
            </div>
