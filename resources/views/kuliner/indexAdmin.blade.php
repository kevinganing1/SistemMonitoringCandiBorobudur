...
<body>
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll active" href="#">Kuliner</a>
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll" href="#">Kuliner</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll" href="/wisataAdmin">Wisata</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll" href="/eventAdmin">Event</a>
          </li>
          <li class="nav-item">
            <div class="dropdown">
  ...
  <div class="intro intro-single route bg-image" style="background-image: url(/img/bg-kuliner-1.jpg)">
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          <h2 class="intro-title mb-4">Kuliner</h2>
        </div>
      </div>
    </div>
  </div>
      ...
      @foreach($data_kuliner as $kuliner)
        <div class="col-md-4">
          <div class="card card-blog">
            <div class="card-img">
              <a href="/pageAdmink/{{$kuliner->id}}"><img src="{{$kuliner->getGambar()}}" alt="" class="img-fluid"></a>
            </div>
            <div class="card-body">
              <h2 class="card-title"><a href="/pageAdmin/{{$kuliner->id}}">{{$kuliner->nama_kuliner}}</a></h2>
              <p class="card-description">
                {{$kuliner->deskripsi}}
              </p>
              <h6 class="card-description"><a href="blog-single.html">{{$kuliner->lokasi}}</a></h6>
            </div>
            <div class="card-footer">
              <div class="post-author">
                <a href="#">
                  <span class="card-title">{{$kuliner->waktu}}</span>
                </a>
              </div>
              <div class="post-date">
                <span class="card-title">{{$kuliner->harga}}</span> 
              </div>
              <div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="/kuliner/create" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
              <div class="form-group">
                <label for="exampleInputEmail1">Nama Kuliner</label>
                <input name="nama_kuliner" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
              </div>
              <div class="form-group">
